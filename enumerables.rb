...
def print_spicy_foods(spicy_foods)
  ...
  spicy_foods.map do |food|
    ...
    "#{food[:name]} (#{food[:cuisine]}) | Heat Level: #{heat_level_emoji}"
  end.each { |formatted_food| puts formatted_food }
end
...
def average_heat_level(spicy_foods)
  ...
  total_foods = spicy_foods.length

  average = total_heat_level.to_f / total_foods
  average.round
end
